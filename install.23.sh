...
7zzs a -mx9 -md512m -mfb273 -ms16g "${ORACLE_SID}".7z "${ORACLE_SID}"
...
if [ "${BUILD_MODE}" == "REGULAR" ] || [ "${BUILD_MODE}" == "SLIM" ]; then
  ...
  if [ "${BUILD_MODE}" == "SLIM" ]; then
    ...
    # Remove old dumps
    rm "${ORACLE_HOME}"/rdbms/utl/upgrade_dump_seed/dbcur19200/*.dmp
    rm "${ORACLE_HOME}"/rdbms/utl/upgrade_dump_seed/dbcur21300/*.dmp
